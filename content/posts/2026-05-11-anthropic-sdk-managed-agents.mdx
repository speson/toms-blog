...
OpenAI도 Agents SDK를 내놨고, Google도 ADK를 발표했고, 이제 Anthropic도 공식적으로 멀티에이전트를 SDK에 넣었어요. 2026년은 에이전트 오케스트레이션이 모델 제공사의 기본 제공 기능이 되는 해가 될 것 같아요. 서드파티 프레임워크들이 어떻게 차별화할지가 다음 관전 포인트가 될 거예요.
