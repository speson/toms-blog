...
<strong>웹훅 기능</strong>도 새로 추가됐어요. 에이전트의 실행 완료, 상태 변경 같은 이벤트를 외부 시스템으로 전달할 수 있어요.
...
<strong>Vault validation</strong>도 눈에 띄는 추가 기능이에요. 에이전트가 외부 서비스에 접근할 때 필요한 인증 정보를 안전하게 관리하는 구조예요.
