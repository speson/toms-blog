...
- 문서 골격 반복 금지 (2026-08): 반론은 진짜 있는 만큼만("정확히 셋" 금지), "이렇게 볼 수도 있어요"·"한국 개발자 입장에서" 고정 헤딩과 "한 줄로 줄이면" 마무리를 매 글 반복하지 않음, 재활용 은유(문법/실물/청구서/옷/화폐/축) 금지 — 상세는 .claude/writing-style.md 3-1·3-2절
